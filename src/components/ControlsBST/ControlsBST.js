  ...
  return (
    <div className={styles.ControlsBST}>
      <form className={styles.ControlsBST__form}>
          ...
          <div className={`${styles["ControlsBST__form-result"]} ${styles["ControlsBST__form-result-4"]}`}>The depth of the given value in the BST is: {"result-placeholder"}</div>
          ...
          <div className={`${styles["ControlsBST__form-result"]} ${styles["ControlsBST__form-result-5"]}`}>The height of the given value in the BST is: {"result-placeholder"}</div>
